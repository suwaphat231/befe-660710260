...
// ถ้า FeaturedBooks เรนเดอร์รายการเองอยู่แล้ว ไม่ต้องใช้ BookCard ซ้ำ
...
const HomePage = () => {
  const categories = [
    ...
    { name: 'ธุรกิจ', icon: '💼', color: 'bg-yellow-100', slug: 'business' },
  ];
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div
                className="bg-viridian-100 p-4 rounded-full w-20 h-20 mx-auto mb-4 
            ...
            <div className="text-center group">
              <div
                className="bg-green-100 p-4 rounded-full w-20 h-20 mx-auto mb-4 
            ...
            <div className="text-center group">
              <div
                className="bg-purple-100 p-4 rounded-full w-20 h-20 mx-auto mb-4 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          {/* ให้ FeaturedBooks จัดการ list ภายในของมันเอง */}
          <FeaturedBooks />
          <div className="text-center mt-8">
            <Link
              to="/books"
              className="inline-flex items-center text-viridian-600 
              hover:text-viridian-700 font-semibold text-lg group"
            >
              ดูหนังสือทั้งหมด
              <ArrowRightIcon
                className="ml-2 h-5 w-5 group-hover:translate-x-2 
      ...
      <section className="py-16 bg-viridian-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">รับข่าวสารและโปรโมชั่นล่าสุด</h2>
